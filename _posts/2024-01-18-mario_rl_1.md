...
description: "Setup of OpenAI Gym for Mario RL, detailing environment, reward shaping and frame preprocessing. Introduces action space and basic agent loop."
---
...
In the [next article]({% post_url 2024-01-25-mario_rl_2 %}) we will explore DDQN and how it is working.
