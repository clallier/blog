---
layout: post
title:  "The Challenges of Mastering Mario Bros with Reinforcement Learning!"
date:   2023-12-25 22:11:33 +0100
categories: Reinforcement Learning, Machine Learning, PPO
---
...
## Section 2: Mario Bros as an RL Challenge

The environment is given by [Gym Super Mario Bros](https://pypi.org/project/gym-super-mario-bros/), based on [OpenAI Gym API] (https://github.com/openai/gym) or https://www.gymlibrary.dev/index.html
This is a simplifed environment: 
- output state: 7 instead of 36 (6^2)  
